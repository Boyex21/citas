        ...
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="{{ Route::is('doctor.leave.*') ? 'active' : '' }}">
              <a class="nav-link" href="{{ route('doctor.leave.index') }}"><i class="fas fa-calendar"></i> <span>Descanso</span></a>
            </li>
            ...
            <li class="{{ Route::is('doctor.location.*') ? 'active' : '' }}">
              <a class="nav-link" href="{{ route('doctor.location.index') }}"><i class="fas fa-map-marker"></i> <span>Ubicaciones</span></a>
            </li>

            <li class="{{ Route::is('doctor.department.*') ? 'active' : '' }}">
              <a class="nav-link" href="{{ route('doctor.department.index') }}"><i class="fas fa-id-card"></i> <span>Departamentos</span></a>
            </li>
            ...
            <li class="{{ Route::is('doctor.chamber.*') ? 'active' : '' }}">
              <a class="nav-link" href="{{ route('doctor.chamber.index') }}"><i class="fas fa-hospital"></i> <span>Especialidades</span></a>
            </li>
            ...
            <li class="{{ Route::is('doctor.documents.*') ? 'active' : '' }}">
              <a class="nav-link" href="{{ route('doctor.documents.index') }}"><i class="fas fa-file"></i> <span>Documentos</span></a>
            </li>
