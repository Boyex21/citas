      ...
      <nav class="navbar navbar-expand-lg main-navbar">
        ...
        <ul class="navbar-nav navbar-right">
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
            @if(Auth::guard('staff')->user()->image)
            <img alt="image" src="{{ asset(Auth::guard('staff')->user()->image) }}" class="rounded-circle mr-1">
            @else
            <img alt="image" src="{{ asset('uploads/website-images/default-avatar.jpg') }}" class="rounded-circle mr-1">
            @endif
            <div class="d-sm-none d-lg-inline-block">{{ Auth::guard('staff')->user()->name }}</div></a>
      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            <li class="{{ Route::is('staff.dashboard') ? 'active' : '' }}">
              <a class="nav-link" href="{{ route('staff.dashboard') }}"><i class="fas fa-home"></i> <span>Inicio</span></a>
            </li>
            ...
            <li class="nav-item dropdown {{ Route::is('staff.appointment') || Route::is('staff.show-appointment') || Route::is('staff.show-prescription') || Route::is('staff.create-appointment') || Route::is('staff.today-appointment') || Route::is('staff.prescription')  ? 'active' : '' }}">
              ...
              <ul class="dropdown-menu">
                <li class="{{ Route::is('staff.create-appointment') ? 'active' : '' }}">
                  <a class="nav-link" href="{{ route('staff.create-appointment') }}">Crear Cita</a>
                </li>

                <li class="{{ Route::is('staff.today-appointment') ? 'active' : '' }}">
                  <a class="nav-link" href="{{ route('staff.today-appointment') }}">Citas de Hoy</a>
                </li>

                <li class="{{ Route::is('staff.appointment') || Route::is('staff.show-appointment') ? 'active' : '' }}">
                  <a class="nav-link" href="{{ route('staff.appointment') }}">Historial de Citas</a>
                </li>

                <li class="{{ Route::is('staff.prescription') || Route::is('staff.show-prescription') ? 'active' : '' }}">
                  <a class="nav-link" href="{{ route('staff.prescription') }}">Prescripciones</a>
                </li>
              </ul>
            </li>

            <li class="{{ Route::is('staff.medicine.*') ? 'active' : '' }}">
              <a class="nav-link" href="{{ route('staff.medicine.index') }}"><i class="fas fa-medkit"></i> <span>Medicinas</span></a>
            </li>

            <li class="{{ Route::is('staff.location.*') ? 'active' : '' }}">
              <a class="nav-link" href="{{ route('staff.location.index') }}"><i class="fas fa-map-marker"></i> <span>Ubicaciones</span></a>
            </li>

            <li class="{{ Route::is('staff.department.*') ? 'active' : '' }}">
              <a class="nav-link" href="{{ route('staff.department.index') }}"><i class="fas fa-id-card"></i> <span>Departamentos</span></a>
            </li>

            <li class="{{ Route::is('staff.schedule.*') ? 'active' : '' }}">
              <a class="nav-link" href="{{ route('staff.schedule.index') }}"><i class="fas fa-calendar"></i> <span>Horarios</span></a>
            </li>

            <li class="{{ Route::is('staff.logout') ? 'active' : '' }}">
              <a class="nav-link" href="{{ route('staff.logout') }}"><i class="fas fa-sign-out-alt"></i> <span>Cerrar Sesión</span></a>
            </li>
          </ul>
        </aside>
      </div>
