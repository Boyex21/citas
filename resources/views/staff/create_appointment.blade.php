  ...
  <section class="section">
    <div class="section-header">
      ...
      <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item active">
          <a href="{{ route('staff.appointment') }}">Citas</a>
        </div>
        <div class="breadcrumb-item">Crear Citas</div>
      </div>
    </div>
    ...
    <div class="section-body">
      ...
      <div class="row mt-4">
        <div class="col">
          <div class="card">
            <div class="card-body">
              <form action="{{ route('staff.store-appointment') }}" method="POST">
                @csrf
  ...
  (function($) {
    ...
    $(document).ready(function () {
      ...
      $("#schedule").on("change", function(){
        ...
        $.ajax({
          type: 'GET',
          url: "{{ route('staff.schedule-avaibility') }}",
