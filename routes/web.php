    ...
    Route::group(['middleware' => ['XSS']], function () {
        ...
        Route::group(['as'=> 'user.', 'prefix' => 'user'],function (){
            ...
            Route::group(['middleware' => ['checkuserprofile']], function () {
                ...
                Route::get('appointment/create', [UserProfileController::class, 'createAppointment'])->name('appointment.create');
                Route::post('appointment/create', [UserProfileController::class, 'storeAppointment'])->name('appointment.store');
                Route::get('get-chambers', [UserProfileController::class, 'getChamber'])->name('get-chambers');
                Route::get('get-schedule', [UserProfileController::class, 'getSchedule'])->name('get-schedule');
                Route::get('schedule-avaibility', [UserProfileController::class, 'scheduleAvaibility'])->name('schedule-avaibility');
                Route::get('appointment/{id}', [UserProfileController::class, 'showAppointment'])->name('show-appointment');
                
// FUNCION EXTRA PACIENTE                

                Route::get('documents', [UserProfileController::class, 'documents'])->name('documents.index');
                Route::get('documents/create', [UserProfileController::class, 'createDocument'])->name('documents.create');
                Route::post('documents/create', [UserProfileController::class, 'storeDocument'])->name('documents.store');
                Route::post('documents/files', [UserProfileController::class, 'fileStore'])->name('documents.store.files');
                Route::post('documents/files/edit', [UserProfileController::class, 'fileEdit'])->name('documents.edit.files');
                Route::post('documents/files/destroy', [UserProfileController::class, 'fileDestroy'])->name('documents.destroy.files');
                Route::get('documents/{id}', [UserProfileController::class, 'showDocument'])->name('documents.show');
                Route::get('documents/edit/{id}', [UserProfileController::class, 'editDocument'])->name('documents.edit');
                Route::put('documents/edit/{id}', [UserProfileController::class, 'updateDocument'])->name('documents.update');
                Route::delete('documents/{id}', [UserProfileController::class, 'deleteDocument'])->name('documents.delete');
