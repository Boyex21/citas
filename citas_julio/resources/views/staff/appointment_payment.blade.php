                        ...
                        <table class="table table-striped" id="dataTable">
                            <thead>
                                <tr>
                                    ...
                                    <th>{{__('user.Total Appointment')}}</th>
                            ...
                            <tbody>
                                @foreach ($payments as $index => $payment)
                                    <tr>
                                        ...
                                        <td>
                                        <a href="{{ route('staff.show-payment',$payment->invoice_id) }}" class="btn btn-primary btn-sm"><i class="fa fa-eye" aria-hidden="true"></i></a>
