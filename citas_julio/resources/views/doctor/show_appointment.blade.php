                            ...
                            <div class="card">
                                <div class="card-body" id="medicineRow">
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <select class="custom-select" id="inputGroupSelect01" name="next_visit_time">
                                                        <option value="{{__('user.Days')}}">{{__('user.Days')}}</option>
                                                        <option value="{{__('user.Months')}}">{{__('user.Months')}}</option>
                                                        <option value="{{__('user.Year')}}">{{__('user.Year')}}</option>
                                                    </select>
                                                  </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <button class="btn btn-primary">{{__('user.Submit')}}</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
