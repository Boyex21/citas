    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">Administradores</div>
            </div>
        </div>

        <div class="section-body">
            <a href="{{ route('admin.admin.create') }}" class="btn btn-primary"><i class="fas fa-plus"></i> Agregar Nuevo</a>
            <div class="row mt-4">
                <div class="col">
                    <div class="card">
                        <div class="card-body">
                                ...
                                <table class="table table-striped" id="dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if($admin->image)
                                                <img src="{{ asset($admin->image) }}" alt="" width="80" class="rounded-circle">
                                                @else
                                                <img src="{{ asset('uploads/website-images/default-avatar.jpg') }}" alt="" width="80" class="rounded-circle">
                                                @endif
                                            </td>
                                            <td>
