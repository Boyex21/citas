        ...
        <div class="row">
          ...
          <div class="col-md-4">
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                <form method="POST" action="{{ route('doctor.send.forget.password') }}">
                  @csrf
            ...
            <div class="mt-5 text-muted text-center">Ya tienes una cuenta? <a href="{{ route('doctor.login') }}">Ingresa</a></div>
