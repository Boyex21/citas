        ...
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="{{ Route::is('staff.location.*') ? 'active' : '' }}">
              <a class="nav-link" href="{{ route('staff.location.index') }}"><i class="fas fa-map-marker"></i> <span>Locaciones</span></a>
            </li>

            <li class="{{ Route::is('staff.department.*') ? 'active' : '' }}">
              <a class="nav-link" href="{{ route('staff.department.index') }}"><i class="fas fa-id-card"></i> <span>Especialidades</span></a>
            </li>
