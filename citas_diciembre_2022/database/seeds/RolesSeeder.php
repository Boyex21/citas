...
class RolesSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $secretary->givePermissionTo(['dashboard', 'appointments.index', 'appointments.create', 'appointments.show', 'appointments.edit', 'appointments.delete', 'appointments.attend', 'appointments.cancel', 'medicines.index', 'medicines.create', 'medicines.show', 'medicines.edit', 'medicines.delete', 'medicines.active', 'medicines.deactive', 'schedules.index', 'schedules.create', 'schedules.show', 'schedules.edit', 'schedules.delete', 'schedules.active', 'schedules.deactive', 'locations.index', 'locations.create', 'locations.show', 'locations.edit', 'locations.delete', 'locations.active', 'locations.deactive']);

        $patient=Role::where('name', 'Paciente')->first();
        $patient->givePermissionTo(['dashboard', 'appointments.index', 'appointments.show', 'documents.index', 'documents.create', 'documents.show', 'documents.edit', 'documents.delete']);
    }
}
