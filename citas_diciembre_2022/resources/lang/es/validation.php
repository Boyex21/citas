...
return [
    ...
    */
    'attributes' => [
        ...
        'date'                  => 'fecha',
        'schedule_id'           => 'horario',
        'blood_pressure'        => 'presión sanguinea',
        'pulse_rate'            => 'frecuencia de pulso',
        'temperature'           => 'temperatura',
        'problem_description'   => 'descripción del problema',
        'covid'                 => 'covid',
        'covid_date'            => 'fecha de contagio',
        'symptoms'              => 'sintomas',
        'symptoms.*'            => 'sintomas',
        'uci'                   => 'internado en uci',
        'covid_state'           => 'estado de recuperación',
        'test'                  => 'examenes',
        'advice'                => 'consejos',
        'days'                  => 'días',
        'time'                  => 'tiempo',
        ...
        'start'                 => 'inicio',
        'end'                   => 'final',
        'appointment_limit'     => 'límite de citas',
        'permission_id'         => 'permiso',
        'permission_id.*'       => 'permiso',
        'logo'                  => 'logo',
        'favicon'               => 'favicon',
        'enable_register'       => 'registro de usuarios'
    ],
];
?>