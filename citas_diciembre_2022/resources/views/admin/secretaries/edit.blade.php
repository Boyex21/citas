	        ...
	        <div class="widget-content widget-content-area shadow-none">
				...
				<div class="row">
					<div class="col-12">
						...
						<form action="{{ route('secretaries.update', ['user' => $user->slug]) }}" method="POST" class="form" id="formSecretary" enctype="multipart/form-data">
							@csrf
							@method('PUT')
							<div class="row">
								...
								<div class="form-group col-12">
									<div class="btn-group" role="group">
										<button type="submit" class="btn btn-primary mr-0" action="secretary">Actualizar</button>
