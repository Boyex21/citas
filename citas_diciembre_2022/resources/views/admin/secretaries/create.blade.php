	        ...
	        <div class="widget-content widget-content-area shadow-none">
	        	<div class="row">
					<div class="col-12">
						...
						<form action="{{ route('secretaries.store') }}" method="POST" class="form" id="formSecretary" enctype="multipart/form-data">
							@csrf
							<div class="row">
								...
								<div class="form-group col-12">
									<div class="btn-group" role="group">
										<button type="submit" class="btn btn-primary" action="secretary">Guardar</button>
