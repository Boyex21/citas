		...
		<div class="user-profile">
			<div class="widget-content widget-content-area">
				<div class="d-flex justify-content-between">
					...
					@can('patients.edit')
					<a href="{{ route('patients.edit', ['user' => $user->slug]) }}" class="mt-2 edit-profile"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-3"><path d="M12 20h9"></path><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"></path></svg></a>
					@endcan
				</div>
				...
				<div class="user-info-list">
					...
					<div class="">
						<ul class="contacts-block list-unstyled mw-100 mx-2 mb-0">
							<li class="contacts-block__item">
								<span class="h6 text-black"><b>Cédula:</b> {{ $user->dni }}</span>
							</li>
							...
							<li class="contacts-block__item">
								<span class="h6 text-black"><b>Fecha de Nacimiento:</b> @if(!is_null($user->birthday)){{ $user->birthday->format('d-m-Y') }}@else{{ 'No Ingresado' }}@endif</span>
							</li>

							<li class="contacts-block__item">
								<span class="h6 text-black"><b>Peso:</b> @if(!is_null($user->weight)){{ number_format($user->weight, 2, ',', '.').'Kg' }}@else{{ 'No Ingresado' }}@endif</span>
							</li>
