...
function generateLang($path = ''){
    ...
    // $paths = array_merge($paths, getAllResourceFiles(resource_path('views/doctor')));
    ...
    $paths = array_merge($paths, getAllResourceFiles(app_path('Http/Controllers/Doctor')));
    $paths = array_merge($paths, getAllResourceFiles(app_path('Http/Controllers/Staff')));
