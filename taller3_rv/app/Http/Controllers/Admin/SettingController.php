...
class SettingController extends Controller
{
    ...
    public function clearDatabase(){
        ...
        Department::truncate();
        Doctor::truncate();
        DoctorBankPayment::truncate();
        DoctorFlutterwave::truncate();
        DoctorInstamojo::truncate();
        DoctorMollie::truncate();
        DoctorPaypal::truncate();
        DoctorPaystack::truncate();
        DoctorRazorpay::truncate();
        DoctorReview::truncate();
        DoctorSocialLink::truncate();
        DoctorStripe::truncate();
        Faq::truncate();
        ...
        PrescriptionMedicine::truncate();
        Schedule::truncate();
        Service::truncate();
        Servicevideo::truncate();
        ServiceFaq::truncate();
        ServiceImageGallery::truncate();
        Slider::truncate();
        Staff::truncate();
        Subscriber::truncate();
        Team::truncate();
    ...
    public function index(){
        ...
        return view('admin.setting',compact('setting','cookieConsent','googleRecaptcha','facebookComment','tawkChat','googleAnalytic','customPaginations','facebookPixel','currencies','pusher'));
    }
