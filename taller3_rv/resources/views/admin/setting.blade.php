                                                ...
                                                <div class="card m-0">
                                                    <div class="card-body">
                                                      <form action="{{ route('admin.update-general-setting') }}" method="POST" enctype="multipart/form-data">
                                                          ...
                                                          <div class="form-group">
                                                              <label for="">{{__('admin.Blog Comment Status')}}</label>
                                                              <select name="blog_comment" id="" class="form-control">
                                                                  <option {{ $setting->blog_comment == 1 ? 'selected' : '' }} value="1">{{__('admin.Enable')}}</option>
                                                                  <option {{ $setting->blog_comment == 0 ? 'selected' : '' }} value="0">{{__('admin.Disable')}}</option>
                                                              </select>
                                                          </div>
                                                ...
                                                <div class="card m-0">
                                                    <div class="card-body">
                                                        <form action="{{ route('admin.update-logo-favicon') }}" method="POST" enctype="multipart/form-data">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="">{{__('admin.Logo Name')}}</label>
                                                            ...
                                                            <div class="form-group">
                                                                <label for="">{{__('admin.Favicon Name')}}</label>
                                                    ...
                                                    <div class="card-body">
                                                        <form action="{{ route('admin.update-cookie-consent') }}" method="POST">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <textarea class="form-control text-area-5" name="message" id="cookie_text" cols="30" rows="5">{{ filterTag(clean($cookieConsent->message)) }}</textarea>
                                                            </div>
