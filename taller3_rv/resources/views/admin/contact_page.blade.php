                    ...
                    <div class="card-body">
                        @if ($contact)
                            <form action="{{ route('admin.contact-us.update',$contact->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-12">
                                        <label>{{__('admin.Emails')}} <span class="text-danger">*</span></label>
                                        <textarea name="email" cols="30" rows="10" class="form-control text-area-5">{!! filterTag(clean($contact->email)) !!}</textarea>

                                    </div>

                                    <div class="form-group col-12">
                                        <label>{{__('admin.Phones')}} <span class="text-danger">*</span></label>
                                        <textarea name="phone" cols="30" rows="10" class="form-control text-area-5">{!! filterTag(clean($contact->phone)) !!}</textarea>
                                    </div>
                                    ...
                                    <div class="form-group col-12">
                                        ...
                                        <textarea name="description" cols="30" rows="10" class="form-control text-area-5">{!! filterTag(clean($contact->description)) !!}</textarea>
                                    </div>
                        ...
                        <form action="{{ route('admin.contact-us.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-12">
                                    <label>{{__('admin.Emails')}} <span class="text-danger">*</span></label>
                                    <textarea name="email" cols="30" rows="10" class="form-control text-area-5"></textarea>
                                </div>

                                <div class="form-group col-12">
                                    <label>{{__('admin.Phone')}} <span class="text-danger">*</span></label>
                                    <textarea name="phone" cols="30" rows="10" class="form-control text-area-5"></textarea>
                                </div>
