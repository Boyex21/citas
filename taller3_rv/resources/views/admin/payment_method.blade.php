                            ...
                            <div class="row">
                                <div class="col-12 col-sm-12 col-md-3">
                                    <ul class="nav nav-pills flex-column" id="myTab4" role="tablist">
                                        ...
                                        <li class="nav-item border rounded mb-1">
                                            <a class="nav-link" id="cash-tab" data-toggle="tab" href="#cashTab" role="tab" aria-controls="cashTab" aria-selected="true">{{__('admin.Hand Cash')}}</a>
                                        </li>
                                    ...
                                    <div class="border rounded">
                                        <div class="tab-content no-padding" id="settingsContent">
                                                    ...
                                                    <div class="card-body">
                                                        <form action="{{ route('admin.update-paypal') }}" method="POST" enctype="multipart/form-data">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div>
                                                                    <img src="{{ asset($paypal->image) }}" width="200px" alt="">
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="card-body">
                                                        <form action="{{ route('admin.update-stripe') }}" method="POST" enctype="multipart/form-data">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="">{{__('admin.Existing Image')}}</label>
                                                                <div>
                                                                    <img src="{{ asset($stripe->image) }}" width="200px" alt="">
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="card-body">
                                                        <form action="{{ route('admin.update-mollie') }}" method="POST" enctype="multipart/form-data">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="">{{__('admin.Current Image')}}</label>
                                                                <div>
                                                                    <img src="{{ asset($paystackAndMollie->mollie_image) }}" width="200px" alt="">
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="card-body">
                                                        <form action="{{ route('admin.update-paystack') }}" method="POST" enctype="multipart/form-data">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="">{{__('admin.Current Image')}}</label>
                                                                <div>
                                                                    <img src="{{ asset($paystackAndMollie->paystack_image) }}" width="200px" alt="">
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="card-body">
                                                        <form action="{{ route('admin.update-instamojo') }}" method="POST" enctype="multipart/form-data">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="">{{__('admin.Current Image')}}</label>
                                                                <div>
                                                                    <img src="{{ asset($instamojo->image) }}" width="200px" alt="">
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="card-body">
                                                        <form action="{{ route('admin.update-bank') }}" method="POST" enctype="multipart/form-data">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <textarea name="account_info" id="" cols="30" rows="10" class="text-area-5 form-control">{{ filterTag(clean($bank->account_info)) }}</textarea>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="">{{__('admin.Existing Image')}}</label>
                                                                <div>
                                                                    <img src="{{ asset($bank->image) }}" width="200px" alt="">
                                                                </div>
                                                            </div>
                                            ...
                                            <div class="tab-pane fade" id="cashTab" role="tabpanel" aria-labelledby="cash-tab">
                                                <div class="card m-0">
                                                    <div class="card-body">
                                                        <form action="{{ route('admin.update-hand-cash') }}" method="POST" enctype="multipart/form-data">
                                                            @csrf
                                                            @method('PUT')
                                                            <div class="form-group">
                                                                <label for="">{{__('admin.Current Image')}}</label>
                                                                <div>
                                                                    <img src="{{ asset($bank->hc_image) }}" width="200px" alt="">
                                                                </div>
                                                            </div>
