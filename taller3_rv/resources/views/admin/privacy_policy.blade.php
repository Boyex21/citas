                            ...
                            <form action="{{ route('admin.privacy-policy.update',$privacyPolicy->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="form-group col-12">
                                        ...
                                        <div>
                                            <img class="admin-banner-img" id="preview-img" src="{{ $privacyPolicy->privacy_banner ? asset($privacyPolicy->privacy_banner) : asset('uploads/website-images/preview.png') }}" width="200px" alt="">
                                        </div>
                                    ...
                                    <div class="form-group col-12">
                                        ...
                                        <textarea id="summernote" name="privacy_policy" cols="30" rows="10" class="summernote">{!! clean($privacyPolicy->privacy_policy) !!}</textarea>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12">
                        ...
                        @else
                            <form action="{{ route('admin.privacy-policy.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-12">
                                        <label>{{__('admin.Privacy Policy')}}<span class="text-danger">*</span></label>
                                        <textarea id="summernote" name="privacy_policy" cols="30" rows="10" class="summernote"></textarea>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12">
