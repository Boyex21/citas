                        ...
                        <form action="{{ route('admin.custom-page.update',$customPage->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <div>
                                        <img src="{{ asset($customPage->banner_image) }}" width="200px" alt="">
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <textarea id="summernote" name="description" cols="30" rows="10" class="summernote">{!! clean($customPage->description) !!}</textarea>
                                </div>
