        ...
        <div class="section-body">
            <div class="row mt-4">
                <div class="col">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('admin.slider-content') }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="form-group">
                                    <label for="">{{__('admin.Slider Title')}}</label>
                                    <input type="text" name="slider_title" class="form-control" value="{{ $content->slider_title }}">
                                </div>
                                <div class="form-group">
                                    <label for="">{{__('admin.Slider Description')}}</label>
                                    <input type="text" name="slider_description" class="form-control" value="{{ $content->slider_description }}">
                                </div>
